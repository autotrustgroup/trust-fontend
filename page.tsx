...
import CarListings from "./d/car-listings";
import CategoryNav from "./d/category-nav";
import NewsSection from "./d/news-section";
import CompareSection from "./d/compare-section";
      ...
      <section className="relative h-[300px] w-full">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/20 to-transparent">
          <div className="container mx-auto h-full relative">
            <h1 className="text-2xl font-semibold text-white absolute top-8 left-4">
