...
const MakeForm = ({
  ...
  return (
    ...
    <form
      onSubmit={onSubmit}
      className="grid grid-cols-4 md:grid-cols-4 lg:grid-cols-12 gap-0"
    >
      {/* First Row */}
      ...
      <div className="col-span-4 md:col-span-2 lg:col-span-4">
        <div className="relative h-full">
          <select
            name="make"
            className="border border-gray-500 px-4 pt-6 pb-2 w-full appearance-none bg-white pr-8 h-full md:border-l-0 border-b-0 md:border-b md:rounded-tr-lg lg:rounded-tr-none"
            value={searchParams.make || ""}
            onChange={handleChange}
            aria-label="Select vehicle make"
          >
      ...
      <div className="col-span-4 md:col-span-2 lg:col-span-4">
        <div className="relative h-full">
          <select
            name="model"
            className="border border-gray-500 px-4 pt-6 pb-2 w-full appearance-none bg-white pr-8 h-full md:border-t-0 lg:border-t lg:border-l-0 lg:rounded-tr-lg border-b-0 md:border-b"
            value={searchParams.model || ""}
            onChange={handleChange}
            aria-label="Select vehicle model"
          >
      ...
      <div className="col-span-4 md:col-span-2 lg:col-span-4">
        <div className="relative h-full w-full">
          <select
            name="price"
            className="border border-gray-500 px-4 pt-6 pb-2 w-full appearance-none bg-white pr-8 h-full md:border-t-0 md:border-l-0 lg:border-l lg:rounded-bl-lg border-b-0 md:border-b md:border-r"
            value={searchParams.price || "2000"}
            onChange={handleChange}
            aria-label="Price"
          >
      ...
      <div className="col-span-2 md:col-span-1 lg:col-span-2">
        <div className="relative h-full w-full">
          <select
            name="radius"
            className="border border-gray-500 px-4 pt-6 pb-2 w-full appearance-none bg-white pr-8 h-full md:border-t-0 md:rounded-bl-lg lg:rounded-bl-none lg:border-l-0 border-r-0 md:border-r"
            value={searchParams.radius || 30}
            onChange={handleChange}
            aria-label="Select search radius"
          >
      ...
      <div className="lg:hidden col-span-4 md:col-span-2 lg:col-span-4 mt-1 pb-2">
