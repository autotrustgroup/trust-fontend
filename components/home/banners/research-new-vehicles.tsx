      ...
      <div className="flex-2 bg-primary-50 rounded-xl flex flex-col-reverse md:flex-row justify-between items-center px-4 md:pl-10 lg:pl-16 md:px-10 p-5 lg:w-3/5 relative overflow-hidden">
        <div className="z-10">
          ...
          <div className="mt-6 flex flex-col md:flex-row gap-3 text-sm">
            <button className="bg-grey-900 text-white px-5 py-2 rounded-full font-semibold hover:opacity-70">
              Research new cars ✦
            </button>
      ...
      <div className="flex-1 bg-grey-50 text-xs relative rounded-xl p-6 pl-8 lg:w-2/5">
        <div className="flex flex-col justify-between w-3/5">
          ...
          <p className="text-gray-700 mb-5 leading-5">
            Alfa Romeo combines Italian elegance with cutting-edge performance,
            delivering a driving experience that is both thrilling and refined.
          </p>
        ...
        <Image
          width={160}
          height={155}
          className="absolute md:right-4 right-16 top-8 lg:right-16 lg:top-8 md:top-1/4 opacity-10 w-52 md:w-40 lg:w-52"
          src="/alpha-romeo.svg"
          alt="alpha-romeo"
        />
      </div>
